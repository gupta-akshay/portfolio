...
import { faGithub, faLinkedin, faTwitter, faYoutube, faInstagram, faFacebook } from '@fortawesome/free-brands-svg-icons'
            ...
            <section id={`${this.props.id}`} className="about" style={{height: this.context.height}}>
                ...
                <Row>
                    ...
                    <Col md={6} className="skills">
                            ...
                            <div className="line-text">
                                <h6>I know I cannot quantify my skills, but this does look great on a page. Right?!</h6>
                            </div>
